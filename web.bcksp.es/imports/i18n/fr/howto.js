		...
		step : {
			download : {
				...
				desc : "Nous utilisons une extension de navigateur web pour collecter les morceaux de texte que vous supprimez. \
						Participez à ce projet en installant une de nos extensions."
			},
			connect : {
				title : "identifiez-vous",
				desc : "Créez votre archive et connectez-vous au moyen de votre extension. Pour vous identifier, nous ne prenons que le minimum, \
						afin de sécuriser vos données au maximum. Seul une adresse email et un mot de passe nous suffisent."
			},
			continue : {
				title : "reprennez votre vie d'internaute",
