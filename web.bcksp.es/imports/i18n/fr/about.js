/*----------------------------------------*\
  ...
  @Last Modified time: 2020-06-04 17:40:12
\*----------------------------------------*/
...
i18n.addTranslation('fr', "about", {
	...
	short : 	"<p>"+
					...
					"se font plus discrète. Les écrans semblent lisse et sans sueur."+
				"</p>"+
				"<p>"+
					"<ul>"+
						"<li>"+
							"Ce projet s'appelle <i>bcksp.es</i>, il tire son nom de la touche «backspace» du clavier informatique. "+
							"Située au-dessus de la touche «enter», elle est utilisée "+
							"pour effacer les derniers caractères saisis, ceux situés à gauche "+
							"du curseur d’écriture."+
						"</li>"+
						"<li>"+
							"<i>bcksp.es</i> archive les mots que vous supprimez en appuyant sur la touche «backspace». "+
							"Ces ratures sont riche de votre intimitée. Nous vous proposons simplement d'y porter le regard."+
						"</li>"+
						"<li>"+
							"<i>bcksp.es</i> vous offre la possibilité de <a href='{$souvenir}'>matérialiser vos ratures</a>."+
						"</li>"+
						"<li>"+
							"<i>bcksp.es</i> organise votre archive dans l'ordre dans laquelle elle s'écrit, <a href='{$editor}'>erreur après erreur</a>."+
						"</li>"+
						"<li>"+
							"<i>bcksp.es</i> considére <a href='{$privacy}'>ses utilisateurs comme auteurs</a>."+
						"</li>"+
						"<li>"+
							"<i>bcksp.es</i> <a href='{$security}'>chiffre vos données</a> sur toute la ligne."+
						"</li>"+
						"<li>"+
							"<i>bcksp.es</i> est une porte vers un espace intérieur où l'erreur et le doute "+
	...
	long : [
		{
			...
			content : [{
				...
				text :  "L'archivage de vos suppression est un processus dévoilant des questions sensibles "+
						...
						"Tout du moins, «<i>bcksp.es»</i> propose de prendre un point de vue "+
			...
			content : [{
				text :  "<ul>"+
							"<li>"+
								...
								"le code de l'extension se déclanche. Dans un premier temps, il vérifie si du texte est sélectionné, "+
							...
							"</li>"+
							"<li>"+
								"Toutes les données gérée par <i>bcksp.es</i> sont transférées de façon chiffrées "+
							...
							"</li>"+
							"<li>"+
								"<i>bcksp.es</i> est hébergé chez <a traget='_blank' href='https://www.phpnet.org//'>phpnet</a> (rue Général Mangin 97-97 bis, 38100 GRENOBLE - France). "+
							...
							"</li>"+
							"<li>"+
								"<i>bcksp.es</i> tourne sur un serveur privé virtuel. Celui-ci n'est dédié qu'au bon fonctionnement de ce projet. "+
								"Le système d'exploitation de cet ordinateur est Debian et est régulièrement mis-à-jour."+
							"</li>"+
							"<li>"+
				...
				text: 	"Le code source est <a target=\"_blank\" href=\"https://github.com/oogre/bcksp.es\">accessible</a>, de ce fait nous garantissons que tout est fait "+
			...
			content : [{
				...
				text: 	"Le <a target=\"_blank\" href=\"https://github.com/oogre/bcksp.es\">code source</a> de l'application web client/serveur et des extensions est sous licence «creative commons» <a href=\"https://creativecommons.org/licenses/by-sa/4.0/\" rel=\"nofollow\"><img src=\"https://camo.githubusercontent.com/6dcc300ab83c479af6c1c1f004b6f9dad77e7736/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f4c6963656e73652d434325323042592d2d5341253230342e302d6c69676874677265792e737667\" alt=\"License: CC BY-SA 4.0\" data-canonical-src=\"https://img.shields.io/badge/License-CC%20BY--SA%204.0-lightgrey.svg\" style=\"max-width:100%;\"></a>. "+
						...
						"<i>bcksp.es</i> ne peut retirer les autorisations concédées par la licence tant que vous appliquez les termes de cette licence. "+
						"Selon les conditions suivantes : "+
						"<ul>"+
							"<li>"+
								"<strong>Attribution</strong> — Vous devez créditer <i>bcksp.es</i>, intégrer un lien vers la licence "+
								"et indiquer si des modifications ont été effectuées à ce projet. Vous devez indiquer ces informations "+
			...
			content : [{
				...
				text :  "<i>bcksp.es</i> abandonne tout droit de paternité sur l'exemplaire en votre possession n°1/2. "+
				...
				subtitle:"exposition",
				text :  "<i>bcksp.es</i> ne génère de bénéfice qu'au travers de la transformation "+
				...
				text :  "<i>bcksp.es</i> est financé également au travers de dons ou de subsides. "+
