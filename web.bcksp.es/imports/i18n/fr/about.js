/*----------------------------------------*\
  ...
  @Last Modified time: 2019-03-02 17:29:01
\*----------------------------------------*/
i18n.addTranslation('fr-FR', {
	about : {
		...
		long : 		"<a id=\"art\" href=\"#art\"><h2>positionnement artistique</h2></a>"+
					...
					"à l’intime et l’absurde.</p>"+
					""+
					"<p>Il s’agit aussi d’un processus dévoilant des questions "+
					...
					"Il aura aussi la possibilité d'être vendu comme objet d'art.</p>"+
					""+
					...
					"Ce triple verou vous garantit une des meilleurs sécurité accessible.</p>"+
					""+
					...
					"</p>"+
					"<p>Les données que vous sotockez sur nos serveur, en tout temps, sont votre propriété. "+
